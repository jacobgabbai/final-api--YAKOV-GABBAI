...
namespace api_final_19.Reposetory
{
...

    {
        ...
        public Test TB1(FinalFContext _context, Test1 z)
        {
        ...
        public Test PutTest1(FinalFContext _context, Test2Dto p)
        ...
        public List<Test> T2( FinalFContext f)
        {    
            Test F = new Test();
        ...
        public Test T21(FinalFContext _context, string i, string v)
        {
            Test? F = new Test();
            List<Test> F1 = new List<Test>();
            List<Test> j = new List<Test>();
            List<Test> Y = _context.Tests.ToList();
            Teacher? T=_context.Teachers.Where(r=>r.TeacherId== i).FirstOrDefault();
        ...
        public Test T211(FinalFContext _context, string i, string v)
        {
            Test? F = new Test();
            List<Test> F1 = new List<Test>();
            List<Test> j = new List<Test>();
        ...
        public Test T22(FinalFContext _context, string v)
        {
            Test? F = new Test();
            List<Test> F1 = new List<Test>();
        ...
        public Test T23(FinalFContext _context, string v)
        {
            Test? F = new Test();
            List<Test> F1 = new List<Test>();
        ...
        public Test T33(FinalFContext _context, string v)
        {
            Test? F = new Test();
            List<Test> F1 = new List<Test>();
        ...
        public int T24(FinalFContext _context, Test1 t)
        {
            Test? F = new Test();
            Test? F2 = new Test();
            List<Test> F1 = new List<Test>();
        ...
        public int TestDelete(FinalFContext _context, string i)
        {
            Test? F = new Test();
            List<Test> F1 = new List<Test>();
