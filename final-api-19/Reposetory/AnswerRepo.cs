...
namespace api_final_19.Reposetory
{
    public class AnswerRepo : IAnswerRepo
    {
        ...
        public Answer AnswerPut(FinalFContext context, AnswerDto1 v)
        {
        ...
        public List<Answer> GetAnswer(FinalFContext context)
        {
        ...
        public List<Answer> GetAnswer1(FinalFContext context, string j)
        {
            List<Answer> T = new List<Answer>();
        ...
        public void TAnswer(FinalFContext context, AnswerDto1 o)
        {           
            List<Answer>? R = context.Answers.ToList();
            Answer tt = new Answer();
