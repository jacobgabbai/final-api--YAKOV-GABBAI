...
namespace api_final_19.Reposetory
{
    ...
    {
        public TestEx1 PostTestEx(FinalFContext context, TestExDto t)
        {
        ...
        public List<TestEx1> GetTestExes(FinalFContext context, string i)
        {
            List<TestEx1> testEx1s = new List<TestEx1>();
            TestEx1 tt = new TestEx1();
        ...
        public List<TestEx1> GetByName1(FinalFContext context, string tname)
        {
            List<TestEx1>? testEx1s = new List<TestEx1>();
            TestEx1? tt = new TestEx1();
            return testEx1s = context.TestEx1s.Where(r => r.TestName == tname).ToList();
        }
        public List<TestEx1> TestSearch(FinalFContext context, string s)
        {
            List<TestEx1>? testEx1s = new List<TestEx1>();
        ...
        public int GetIdName(FinalFContext context, string sname, string stest)
        {
            List<TestEx1>? testEx1s = new List<TestEx1>();
            TestEx1? tt = new TestEx1();
