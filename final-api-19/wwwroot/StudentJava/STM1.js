...
function TestHistory1() {
    ...
    window.open("https://localhost:7115/StudentHtml/Student-history.html")
}
...
function taketest2() {
    ...
    if (itson == null) {
        window.open("https://localhost:7115/StudentHtml/H.html")
    }
...
function testsearch() {
    ...
    window.open("https://localhost:7115/StudentHtml/testsearch.html")
}
